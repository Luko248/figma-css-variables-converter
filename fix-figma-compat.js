...
if (
  !codeContent.includes("var module = ") &&
  !codeContent.includes("var exports = ")
) {
  codeContent =
    "// Figma compatibility: Define module and exports globals\n" +
    "var module = { exports: {} };\n" +
...
if (originalContent !== codeContent) {
  ...
  console.log(
    "✅ Fixed Figma compatibility issues in code.js (__dirname and module.exports removed)"
  );
} else {
